...
describe('BloodPressure e2e test', () => {
    ...
    const bloodPressureSample = { timestamp: '2025-01-08T03:13:11.765Z', systolic: 14921, diastolic: 10239 };
    ...
    describe('new BloodPressure page', () => {
        ...
        it('should create an instance of BloodPressure', () => {
            cy.get(`[data-cy="timestamp"]`).type('2025-01-08T10:03');
            cy.get(`[data-cy="timestamp"]`).blur();
            cy.get(`[data-cy="timestamp"]`).should('have.value', '2025-01-08T10:03');

            cy.get(`[data-cy="systolic"]`).type('23042');
            cy.get(`[data-cy="systolic"]`).should('have.value', '23042');

            cy.get(`[data-cy="diastolic"]`).type('9362');
            cy.get(`[data-cy="diastolic"]`).should('have.value', '9362');
