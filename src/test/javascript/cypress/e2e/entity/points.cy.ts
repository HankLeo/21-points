...
describe('Points e2e test', () => {
    ...
    const pointsSample = { date: '2025-01-08' };
    ...
    describe('new Points page', () => {
        ...
        it('should create an instance of Points', () => {
            ...
            cy.get(`[data-cy="date"]`).should('have.value', '2025-01-08');

            cy.get(`[data-cy="exercise"]`).type('28281');
            cy.get(`[data-cy="exercise"]`).should('have.value', '28281');

            cy.get(`[data-cy="meals"]`).type('31981');
            cy.get(`[data-cy="meals"]`).should('have.value', '31981');

            cy.get(`[data-cy="alcohol"]`).type('16670');
            cy.get(`[data-cy="alcohol"]`).should('have.value', '16670');

            cy.get(`[data-cy="notes"]`).type('scared');
            cy.get(`[data-cy="notes"]`).should('have.value', 'scared');
