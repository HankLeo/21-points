...
import { getEntities, searchEntities } from './preferences.reducer';
            ...
            <h2 id="preferences-heading" data-cy="PreferencesHeading">
                ...
                <div className="d-flex justify-content-end">
                    <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
                        ...
                        <Translate contentKey="twentyOnePointsApp.preferences.home.refreshListLabel">Refresh List</Translate>
                    </Button>
                    <Link
                        to="/preferences/new"
                        ...
                        <FormGroup>
                            <InputGroup>
                                <Input
                                    ...
                                    placeholder={translate('twentyOnePointsApp.preferences.home.search')}
                                />
                ...
                {preferencesList && preferencesList.length > 0 ? (
                        ...
                        <thead>
                            <tr>
                                <th className="hand" onClick={sort('id')}>
                                    <Translate contentKey="twentyOnePointsApp.preferences.id">ID</Translate>{' '}
                                    <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                                </th>
                                <th className="hand" onClick={sort('weeklyGoal')}>
                                    <Translate contentKey="twentyOnePointsApp.preferences.weeklyGoal">Weekly Goal</Translate>{' '}
                                    <FontAwesomeIcon icon={getSortIconByFieldName('weeklyGoal')} />
                                </th>
                                <th className="hand" onClick={sort('weightUnits')}>
                                    <Translate contentKey="twentyOnePointsApp.preferences.weightUnits">Weight Units</Translate>{' '}
                                    <FontAwesomeIcon icon={getSortIconByFieldName('weightUnits')} />
                                </th>
                                <th>
                        ...
                        <tbody>
                            {preferencesList.map((preferences, i) => (
                                <tr key={`entity-${i}`} data-cy="entityTable">
                                    ...
                                    <td>
                                        <Translate contentKey={`twentyOnePointsApp.Units.${preferences.weightUnits}`} />
                                    </td>
                                    ...
                                    <td className="text-end">
                                        <div className="btn-group flex-btn-group-container">
                                            ...
                                            <Button
                                                tag={Link}
                                                to={`/preferences/${preferences.id}/edit`}
                                                color="primary"
                                                size="sm"
                                            ...
                                            <Button
                                                onClick={() => (window.location.href = `/preferences/${preferences.id}/delete`)}
                                                color="danger"
                                                size="sm"
                    ...
                    !loading && (
                        <div className="alert alert-warning">
                            <Translate contentKey="twentyOnePointsApp.preferences.home.notFound">No Preferences found</Translate>
                        </div>
                    )
                )}
            </div>
