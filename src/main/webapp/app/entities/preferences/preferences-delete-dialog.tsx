...
import { deleteEntity, getEntity } from './preferences.reducer';
...
export const PreferencesDeleteDialog = () => {
    ...
    return (
        <Modal isOpen toggle={handleClose}>
            ...
            <ModalBody id="twentyOnePointsApp.preferences.delete.question">
                <Translate contentKey="twentyOnePointsApp.preferences.delete.question" interpolate={{ id: preferencesEntity.id }}>
