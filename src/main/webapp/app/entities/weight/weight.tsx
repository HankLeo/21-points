...
import { getEntities, reset, searchEntities } from './weight.reducer';
            ...
            <h2 id="weight-heading" data-cy="WeightHeading">
                ...
                <div className="d-flex justify-content-end">
                    <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
                        ...
                        <Translate contentKey="twentyOnePointsApp.weight.home.refreshListLabel">Refresh List</Translate>
                    </Button>
                        ...
                        <FormGroup>
                            <InputGroup>
                                <Input
                                    ...
                                    placeholder={translate('twentyOnePointsApp.weight.home.search')}
                                />
                    ...
                    {weightList && weightList.length > 0 ? (
                            ...
                            <thead>
                                <tr>
                                    <th className="hand" onClick={sort('id')}>
                                        <Translate contentKey="twentyOnePointsApp.weight.id">ID</Translate>{' '}
                                    ...
                                    <tr key={`entity-${i}`} data-cy="entityTable">
                                        ...
                                        <td className="text-end">
                                            <div className="btn-group flex-btn-group-container">
                                                ...
                                                <Button
                                                    onClick={() => (window.location.href = `/weight/${weight.id}/delete`)}
                                                    color="danger"
                                                    size="sm"
                        ...
                        !loading && (
                            <div className="alert alert-warning">
                                <Translate contentKey="twentyOnePointsApp.weight.home.notFound">No Weights found</Translate>
                            </div>
                        )
                    )}
                </InfiniteScroll>
