        ...
        <Row>
            <Col md="8">
                <h2 data-cy="pointsDetailsHeading">
                    <Translate contentKey="twentyOnePointsApp.points.detail.title">Points</Translate>
                </h2>
                <dl className="jh-entity-details">
                    ...
                    <dd>
                        {pointsEntity.date ? <TextFormat value={pointsEntity.date} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}
                    </dd>
                    <dt>
                        <span id="exercise">
